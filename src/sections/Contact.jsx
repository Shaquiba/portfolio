...
import Particlemenu from "../components/Particlemenu";
...
const handleSubmit = async (e) =>{
  ...
  return(
    <section id="contact" className="w-full min-h-screen relative bg-black overflow-hidden text-white py-20 px-6
    md:px-20 flex flex-col md:flex-row items-center gap-10
    ">
<Particlemenu/>
...
transition={{duration:0.6}}
>
<h2 className="text-2xl font-bold mb-2 italic">Lets Work Together</h2>
